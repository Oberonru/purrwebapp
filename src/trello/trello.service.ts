    ...
    return new Promise((resolve, reject) => {
      ...
      this.oauth.getOAuthAccessToken(
        ...
        async (error, accessToken, accessTokenSecret, results) => {
          ...
          const jwtToken = sign({ userId: data.id }, config.jwtSecret);

          //https://api.trello.com/1/cards/SJiEgdx3?key=3f06054f19b7002c4f55424fb1d20b26&token=ATTA971217cd964f7a7a4f3c96813b12dba60e8219e24e01f20cfed60dcbf8bc7dbd12538423
